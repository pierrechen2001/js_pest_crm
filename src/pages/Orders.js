...
const taiwanDistricts = {
  ...
  "新北市": [
    ...
    "泰山區", "三芝區", "深坑區", "石碇區", "新店區", "坪林區", "烏來區", 
    "蘆洲區", "五股區"
  ],
  "桃園市": [
    "桃園區", "中壢區", "平鎮區", "八德區", "楊梅區", "大溪區", "龜山區", 
    "龍潭區", "大園區", "觀音區", "新屋區", "復興區", "蘆竹區"
  ],
  "台中市": [
    "中區", "東區", "南區", "西區", "北區", "西屯區", "南屯區", "北屯區", 
    "大甲區", "大里區", "太平區", "潭子區", "清水區", "梧棲區", "龍井區", 
    "沙鹿區", "大肚區", "和平區", "霧峰區", "烏日區", "豐原區", "后里區", 
    "東勢區", "石岡區", "新社區", "神岡區", "大雅區", "外埔區", "大安區"
  ],
  "台南市": [
    "中西區", "東區", "南區", "北區", "安平區", "安南區", "永康區", 
    "歸仁區", "新化區", "左鎮區", "玉井區", "楠西區", "南化區", "仁德區", 
    "關廟區", "龍崎區", "官田區", "麻豆區", "佳里區", "西港區", "七股區", 
    "將軍區", "學甲區", "北門區", "新市區", "鹽水區", "白河區", "善化區",
    "東山區", "六甲區", "下營區", "柳營區", "新營區", "後壁區", "大內區", 
    "山上區", "安定區"
  ],
  "高雄市": [
    ...
    "桃源區", "旗津區", "烏松區", "仁武區", "大社區", "岡山區", "路竹區", 
    "橋頭區", "梓官區", "彌陀區", "永安區", "燕巢區", "田寮區", "阿蓮區", 
    "茄萣區", "湖內區", "茂林區", "那瑪夏區"
  ],
  "基隆市": [
  ...
  "新竹縣": [
    ...
    "五峰鄉", "橫山鄉", "尖石鄉", "北埔鄉", "峨眉鄉", "新埔鎮"
  ],
  "苗栗縣": [
    "苗栗市", "三灣鄉", "獅潭鄉", "後龍鎮", "通霄鎮", "南庄鄉", "大湖鄉", 
    "公館鄉", "銅鑼鄉", "三義鄉", "西湖鄉", "卓蘭鎮", "苑裡鎮", "竹南鎮", 
    "頭份鎮", "頭屋鄉", "造橋鄉", "泰安鄉"
  ],
  "屏東縣": [
    "屏東市", "三地門鄉", "霧台鄉", "瑪家鄉", "九如鄉", "里港鄉", "高樹鄉", "鹽埔鄉", "長治鄉", 
    "麟洛鄉", "竹田鄉", "內埔鄉", "萬丹鄉", "潮州鄉", "東港鄉", "南州鄉", "佳冬鄉", "新園鄉", 
    "枋寮鄉", "枋山鄉", "春日鄉", "獅子鄉", "車城鄉", "恆春鄉", "滿州鄉", "萬巒鄉", "新埤鄉", "崁頂鄉", "林邊鄉", "琉球鄉", "泰武鄉", "來義鄉", "牡丹鄉"
  ],
  "台東縣": [
    "台東市", "綠島鄉", "蘭嶼鄉", "延平鄉", "卑南鄉", "鹿野鄉", "關山鄉", "海端鄉", "池上鄉", 
    "東河鄉", "成功鄉", "長濱鄉", "太麻里鄉", "金峰鄉", "大武鄉", "達仁鄉"
  ],
  "澎湖縣": [
    "馬公市", "西嶼鄉", "望安鄉", "湖西鄉", "白沙鄉", "七美鄉"
  ],
  "嘉義市": ["東區", "西區"],
  "嘉義縣": [
  ...
  "彰化縣": [
    ...
    "田尾鄉", "埤頭鄉", "芳苑鄉", "大城鄉", "竹塘鄉", "溪州鄉", "伸港鄉", "線西鄉", 
    "福興鄉", "秀水鄉", "溪州鄉"
  ],
  "南投縣": [
