export const taiwanCities = ["台北市", "新北市", "桃園市", "台中市", "台南市", "高雄市", "基隆市", "新竹市", "嘉義市", "新竹縣", "苗栗縣", "彰化縣", "南投縣", "雲林縣", "嘉義縣", "屏東縣", "宜蘭縣", "花蓮縣", "台東縣", "澎湖縣", "金門縣", "連江縣"];
...
export const getDistrictsByCity = (city) => {
  return taiwanDistricts[city] || [];
};

// 工具函數：驗證縣市區域組合是否有效
export const isValidCityDistrict = (city, district) => {
...
export const getAllDistricts = () => {
  return Object.values(taiwanDistricts).flat();
};
